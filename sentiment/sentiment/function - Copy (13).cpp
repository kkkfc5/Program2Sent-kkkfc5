...
void printPos(vector<wordStruct> formattedReview, vector<wordStruct> originalReview, vector<int>& changedIndex, vector<char> punctuation) { // prints the words updated to be more negative
    ...
    }   // NEED TO MAKE NEW VECTOR TO STOARE ORIGINAL WITHOUT PUNCT, NEED TO SET FIXED SETPRECISION TO 2, NEED TO FIX WHAT IS DIRECTLY INDER TIS LINE WHERE IT PRINTS OUT THE UPDATED REVIEW
