...
int processReview(string fileName, vector<wordStruct> wordList, vector<wordStruct> posList, vector<wordStruct> negList) {
    ...
    int index = 0;
    int formattedIndex = 0; // tracks the iteration the word loop is on ;; ie. tracks the current word's index in the vector
    vector<int> universalReplaceIndex; // index of word to be replaced (in the original file)
