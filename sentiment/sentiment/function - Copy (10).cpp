...
void reviewSentiment(vector<wordStruct> wordList, vector<wordStruct>& formattedReview, vector<wordStruct>& originalReview, vector<int>& universalChangedIndex) { // initializes values for each element of the formattedReview, and then copies those values into original review 
